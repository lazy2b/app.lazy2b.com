 ...
 * 文件名:TrimPhotoUtils.java
 * 创  建:2015年10月27日下午1:51:43
 ...
 * @version $Id$
 */
public class TrimPhotoUtils implements ILazyBase {
	//
	/**
	 * 将图片变成圆形的工具
	 * 
	 ...
	 * @return
	 */
	public static Bitmap bitmapIntoCercle(Bitmap mBitmap) {
		if (mBitmap == null)
			return null;
